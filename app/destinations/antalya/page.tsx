...
export const metadata = {
  title: "Antalya | Diş Tedavi Rehberi",
  description: "Antalya için şehir seçimi, süreç ve randevu notlari.",
};
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid lg:grid-cols-2 gap-8 items-center bg-white border border-gray-200 rounded-3xl shadow-sm p-6 md:p-8">
          <div className="space-y-4">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold">Antalya</h1>
            <p className="text-gray-700">
              Ulaşım kolayligi ve klinik yoğunluğu nedeniyle tercih edilen bir şehir.
            </p>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 pb-14">
        <section className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8 space-y-4">
          ...
          <p className="text-gray-700 leading-relaxed">
            Antalya, randevu planlamasi ve ulaşım acisindan pratik secenekler sunar.
          </p>
        </section>

        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-brand-secondary">Neden Antalya?</h2>
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 space-y-3">
            <ul className="list-disc list-inside text-gray-700 space-y-2 text-sm">
              <li>Klinik ve laboratuvar seçenekleri</li>
